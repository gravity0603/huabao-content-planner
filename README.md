...
[![Version](https://img.shields.io/badge/version-v6.3.5-2f6f6d.svg)](CHANGELOG.md) [![Structure](https://img.shields.io/badge/structure-single--source-2f6f6d.svg)](SKILL.md)

> 面向华为杂志锁屏运营的内容策划 Skill：从最新素材和数据出发，完成选题、来源核验、概念去重、双目标评分和出街前审核。

当前版本：**v6.3.5**（2026-09-10）
...
- 旅行/萌宠的7字限制不得压掉事实主语、对象关系或关键动作。旅行标题先抓景观最炸裂的题眼，再选画面命名、动态陈述、空间反差或真问题；问句不是默认结构。同批至少覆盖三类结构，单一结构不得超过半数。可用拟人、疑问和视觉隐喻，但必须有具体对象，且副标题、落地页清楚兑现地点、真相和机制。以“还能这样？！”的新鲜反差筛选修辞，不一刀切禁用“像月球、会跳舞”等有效画面翻译；淘汰“会唱歌”等已失去陌生感的旧比喻。
- 旅行标题必须通过“熟词撞生景”的网感闸门：用可被首图证明的生活动作或口语，把陌生景观翻译成一句可转述的话；拒绝“地理名词+现象”的说明词组。遮住副标题后仍应在半秒内看见具体反常画面。同一口语词、拟人动作或句式每批最多2次，避免批量套梗。
...
详见 [`CHANGELOG.md`](CHANGELOG.md)。当前版本：v6.3.5；已加入旅行标题“熟词撞生景”的网感闸门。
