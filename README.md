...
[![Version](https://img.shields.io/badge/version-v6.3.4-2f6f6d.svg)](CHANGELOG.md) [![Structure](https://img.shields.io/badge/structure-single--source-2f6f6d.svg)](SKILL.md)

> 面向华为杂志锁屏运营的内容策划 Skill：从最新素材和数据出发，完成选题、来源核验、概念去重、双目标评分和出街前审核。

当前版本：**v6.3.4**（2026-09-10）
...
详见 [`CHANGELOG.md`](CHANGELOG.md)。当前版本：v6.3.4；已加入旅行标题“题眼决定结构”的批量复核闸门。
