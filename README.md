...
[![Version](https://img.shields.io/badge/version-v6.3.3-2f6f6d.svg)](CHANGELOG.md) [![Structure](https://img.shields.io/badge/structure-single--source-2f6f6d.svg)](SKILL.md)

> 面向华为杂志锁屏运营的内容策划 Skill：从最新素材和数据出发，完成选题、来源核验、概念去重、双目标评分和出街前审核。

当前版本：**v6.3.3**（2026-09-10）
...
- 旅行/萌宠的7字限制不得压掉事实主语、对象关系或关键动作。旅行标题优先将可核事实翻译成一秒可见的反常画面，可用拟人、疑问和视觉隐喻；但必须有具体对象，且副标题、落地页清楚兑现地点、真相和机制。以“还能这样？！”的新鲜反差筛选修辞，不一刀切禁用“像月球、会跳舞”等有效画面翻译；淘汰“会唱歌”等已失去陌生感的旧比喻。
...
详见 [`CHANGELOG.md`](CHANGELOG.md)。当前版本：v6.3.3；已加入旅行标题的“新鲜反差”闸门。
